...
export function NowPlayingBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-gray-950 text-white shadow-2xl">
      <div
      ...
      <div className="max-w-5xl mx-auto flex items-center gap-4 px-6 py-3">
        ...
        <div className="text-xs text-gray-400 tabular-nums flex-shrink-0 ml-4 w-20 text-right">
